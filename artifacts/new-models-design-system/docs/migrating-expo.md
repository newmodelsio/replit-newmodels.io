...
`artifacts/new-models-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/new-models-design-system/lib/native-theme` and
  `@workspace/new-models-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/new-models-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/new-models-design-system` and retains only
