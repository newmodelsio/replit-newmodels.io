# New Models Design System design system
...
workspace package (`@workspace/new-models-design-system`): other artifacts depend
...
for `@workspace/new-models-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/new-models-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/new-models-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/new-models-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/new-models-design-system/docs/consuming-slides.md`
...
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/new-models-design-system/docs/migrating-expo.md`
